    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking_hotels.city')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_images', to='booking_hotels.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='booking_hotels.hotel')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='booking_hotels.review')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('люкс', 'люкс'), ('семейный', 'семейный'), ('oдноместный', 'oдноместный'), ('двухместный', 'двухместный')], max_length=16)),
                ...
                ('hotel_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='booking_hotels.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('hotel_book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking_hotels.hotel')),
                ('room_book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking_hotels.room')),
            ],
        ),
        migrations.CreateModel(
            name='RoomImage',
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='room_images', to='booking_hotels.room')),
            ],
        ),
    ]
